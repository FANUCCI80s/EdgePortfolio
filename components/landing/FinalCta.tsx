  ...
  return (
    <section className="relative overflow-hidden border-t border-white/[0.06] bg-[#050505] py-28">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2rem] border border-emerald-500/20 bg-black/45 px-6 py-20 text-center shadow-2xl backdrop-blur-md sm:px-12">
          ...
          {/* Gold glows */}
          <div className="pointer-events-none absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-500/10 blur-3xl" />

          <div className="pointer-events-none absolute bottom-0 left-1/2 h-48 w-48 -translate-x-1/2 translate-y-1/2 rounded-full bg-emerald-500/[0.07] blur-3xl" />
          ...
          <div className="relative">
            ...
            <p className="mt-7 text-xs font-bold uppercase tracking-[0.25em] text-emerald-400">
              EDGE PORTFOLIO
            </p>

            <h2 className="mx-auto mt-5 max-w-3xl text-4xl font-bold tracking-tight !text-[#FFFFFF] sm:text-6xl">
              Build your Edge Portfolio in the markets.
            </h2>
            ...
            <div className="mt-10 flex flex-col justify-center gap-3 sm:flex-row">
              <Link
                href="/signup"
                className="rounded-2xl bg-emerald-500 px-7 py-4 text-sm font-bold !text-[#FFFFFF] transition hover:brightness-110"
              >
                Create Your Account
              </Link>
              ...
              <Link
                href="/login"
                className="rounded-2xl border border-white/10 bg-white/[0.04] px-7 py-4 text-sm font-bold !text-[#FFFFFF] transition hover:border-emerald-500/30 hover:bg-white/[0.07]"
              >
                Log In
              </Link>
            </div>
